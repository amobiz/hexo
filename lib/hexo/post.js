  ...
  return new Promise(function(resolve, reject) {
    ...
    return ctx.execFilter('before_post_render', data, {context: ctx}).then(function() {
      data.content = data.content.replace(rEscapeContent, function(match, content) {
        // amobiz: FIX: disable code block escape:
        // hexo try to escape contents like this:
        // <pre><code> .... </code><pre>
        // The problem is, when fenced code or code like above inside a swig tag,
        // it will be escaped again in the very next promise.then() block, and won't be process anymore.
        return content;
